...
A static, dark-themed portfolio site showcasing 7 BI dashboards (Power BI + Tableau), each written up as a short case study: the question, what the dashboard shows, and a recommendation. It also lists three certifications.
